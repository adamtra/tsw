<template>
    ...
    <div v-else>
        <v-card>
                                ...
                                <v-layout wrap>
                                    <v-flex xs12>
                                        <v-text-field
                                                ...
                                                :rules="emptyRules"
                                                :disabled="classData.zamknieta || blocked"
                                    ...
                                    <v-flex xs12>
                                        <v-autocomplete
                                                ...
                                                :disabled="!isNew && (classData.zamknieta || classData.horses.filter((x) => x.wynik.oceniono).length > 0 || blocked)"
                                                required></v-autocomplete>
                                    </v-flex>
                                </v-layout>
                            </v-container>
            ...
            <v-card-actions v-if="!classData.zamknieta && !blocked">
                <v-spacer></v-spacer>
